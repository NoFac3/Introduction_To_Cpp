		...
		if (item != 'T')						// If user imput is not 'T': For entering items
		{
			...
			else
			{
				...
				case 'P':																										// Pine
					...
					break;
				case 'F':																										// Fir
					cout << count << " " << width << "x" << height << "x" << length << " Fir at a cost of " << cost << endl;	// Print to console output
					outputFile << count << " " << width << " " << height << " " << length << " Fir " << cost << endl;			// Write to output file
					break;
				case 'C':																										// Cedar
					cout << count << " " << width << "x" << height << "x" << length << " Cedar at a cost of " << cost << endl;	// Print to console output
					outputFile << count << " " << width << " " << height << " " << length << " Cedar " << cost << endl;			// Write to output file
					break;
				case 'M':																										// Maple
					cout << count << " " << width << "x" << height << "x" << length << " Maple at a cost of " << cost << endl;	// Print to console output
					outputFile << count << " " << width << " " << height << " " << length << " Maple " << cost << endl;			// Write to output file
					break;
				case 'O':																										// Oak
					cout << count << " " << width << "x" << height << "x" << length << " Oak at a cost of " << cost << endl;	// Print to console output.
					outputFile << count << " " << width << " " << height << " " << length << " Oak " << cost << endl;			// Write to output file.
					break;
				}
